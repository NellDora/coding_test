...
예제 2번의 numbers의 마지막 원소 전까지의 원소를 sum에 더하면 139입니다. 139는 n 값인 139보다 크지 않고 마지막 원소인 100을 더하면 139보다 커지므로 239를 return 합니다.
    ...
    public static void main (String[] args){
        LV0Solution41 solution41 = new LV0Solution41();
        System.out.println(solution41.solution(new int[]{34,5,71,29,100,34},123));
        System.out.println(solution41.solution(new int[]{58,44,27,10,100},139));
    }
